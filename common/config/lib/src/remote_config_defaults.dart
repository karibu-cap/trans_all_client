...
Map<String, dynamic> _remoteConfigDefaultsDev = {
  ...
  RemoteConfigKeys.facebookLinkPage: 'https://www.facebook.com',
  RemoteConfigKeys.instagramLinkPage: 'https://www.intagram.com',
  RemoteConfigKeys.twitterLinkPage: 'https://www.twitter.com',
